...
export class ProjectService {
  ...
  public getUserProjects() : Observable<Project[]> {
    return this.http.get<Project[]>(`https://api.${API_URL}/v1/github/repos`,{
  ...
  public create(domain: string, github_name: string): Observable<void> {
    console.log("creating project with " + domain + " and repo " + github_name);
